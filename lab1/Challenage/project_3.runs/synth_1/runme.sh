...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab1/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log designs.vds -m64 -mode batch -messageDb vivado.pb -notrace -source designs.tcl
