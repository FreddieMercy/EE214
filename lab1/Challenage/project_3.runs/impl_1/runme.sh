...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab1/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log designs.vdi -applog -m64 -messageDb vivado.pb -mode batch -source designs.tcl -notrace
