...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_sw.vdi -applog -m64 -messageDb vivado.pb -mode batch -source led_sw.tcl -notrace
