...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_sw.vds -m64 -mode batch -messageDb vivado.pb -notrace -source led_sw.tcl
