...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab7/Stop_Watch/Stop_Watch/Stop_Watch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_block.vds -m64 -mode batch -messageDb vivado.pb -notrace -source counter_block.tcl
