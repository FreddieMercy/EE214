...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab7/Stop_Watch/Stop_Watch/Stop_Watch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_block.vdi -applog -m64 -messageDb vivado.pb -mode batch -source counter_block.tcl -notrace
