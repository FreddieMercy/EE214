...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab4/Challenage/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sum.tcl
