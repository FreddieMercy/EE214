...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab4/Challenage/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sum.tcl -notrace
