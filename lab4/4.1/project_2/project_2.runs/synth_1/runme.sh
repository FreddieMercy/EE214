...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab4/project_1/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dec.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dec.tcl
