...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab4/project_1/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dec.vdi -applog -m64 -messageDb vivado.pb -mode batch -source dec.tcl -notrace
