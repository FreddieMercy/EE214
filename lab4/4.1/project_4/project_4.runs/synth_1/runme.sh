...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab4/project_1/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sft.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sft.tcl
