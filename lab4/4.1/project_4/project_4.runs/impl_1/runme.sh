...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab4/project_1/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sft.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sft.tcl -notrace
