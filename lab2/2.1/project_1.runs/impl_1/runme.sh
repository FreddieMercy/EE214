...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project0_demo.vdi -applog -m64 -messageDb vivado.pb -mode batch -source project0_demo.tcl -notrace
