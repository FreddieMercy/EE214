...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project0_demo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source project0_demo.tcl
