...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab5/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_divider.vdi -applog -m64 -messageDb vivado.pb -mode batch -source clk_divider.tcl -notrace
