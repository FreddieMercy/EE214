...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab5/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_divider.vds -m64 -mode batch -messageDb vivado.pb -notrace -source clk_divider.tcl
