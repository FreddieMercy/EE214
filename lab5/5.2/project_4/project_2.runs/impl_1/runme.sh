...
HD_PWD='C:/Users/junhao.zhang.freddie/Vivado_Projects/lab5/project_2/project_4/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sr_latch.vdi -applog -m64 -messageDb vivado.pb -mode batch -source sr_latch.tcl -notrace
